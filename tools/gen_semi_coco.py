...
def gen_semi_data(data_dir, json_file, percent=10.0, seed=1, seed_offset=0, txt_file=None):
    ...
    print('Totally {} images and {} annotations, about {} gts per image.'.format(
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default='/paddle/dataset/coco')
    parser.add_argument('--json_file', type=str, default='annotations/instances_train2017.json')
    ...
    print(args)
    gen_semi_data(args.data_dir, args.json_file, args.percent, args.seed, args.seed_offset, args.txt_file)
