...
model_type=yolox
job_name=yolox_${name}_crn_coco_3x
config=configs/${model_type}/${job_name}.yml
log_dir=log_dir/${job_name}

weight_path=../best_model.pdparams
...
# 6. deploy speed
#CUDA_VISIBLE_DEVICES=1 python3.7 deploy/python/infer.py --model_dir=output_inference/${job_name} --image_file=demo/000000014439.jpg --device=GPU --run_benchmark=True --trt_max_shape=640 --trt_min_shape=640 --trt_opt_shape=640 --run_mode=trt_fp16
