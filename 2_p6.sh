...
#CUDA_VISIBLE_DEVICES=7 python3.7 tools/eval.py -c ${config} -o weights=../${job_name}_paddle.pdparams #--classwise #./${job_name}_final_fromori_noneedrgb.pdparams
# im8 59.6
...
#CUDA_VISIBLE_DEVICES=0 python3.7 tools/infer.py -c ${config} -o weights=../${job_name}_paddle.pdparams  --infer_img=demo/000000570688.jpg #--draw_threshold=0.5
...
#CUDA_VISIBLE_DEVICES=0 python3.7 tools/export_model.py -c ${config} -o weights=../${job_name}_paddle.pdparams #./${job_name}_final_fromori_noneedrgb.pdparams
