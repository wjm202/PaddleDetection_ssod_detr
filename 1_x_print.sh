...
CUDA_VISIBLE_DEVICES=2 python3.7 tools/eval.py -c ${config} -o weights=../../../paddle_${job_name}.pdparams
...
CUDA_VISIBLE_DEVICES=0 python3.7 tools/infer.py -c ${config} -o weights=../../../paddle_${job_name}.pdparams --infer_img=demo/000000014439.jpg
