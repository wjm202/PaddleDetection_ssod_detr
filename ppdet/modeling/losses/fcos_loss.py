...
class FCOSLoss(nn.Layer):
    ...
    def __iou_loss(self, pred, targets, positive_mask, weights=None, return_iou=False):
        """
    ...
    def forward(self, cls_logits, bboxes_reg, centerness, tag_labels,
        ...
        if self.quality == 'centerness':
            ...
            reg_loss = self.__iou_loss(
                ...
                weights=tag_center_flatten) # [61570] tag_center_flatten.sum()=34.43262482
            ...
            quality_loss = ops.sigmoid_cross_entropy_with_logits(centerness_flatten,
                                                            tag_center_flatten)
            ...
            # num_positive_fp32 = num_foreground
            ...
            gt_ious = self.__iou_loss(
                ...
                weights=None,
                return_iou=True)
            quality_loss = ops.sigmoid_cross_entropy_with_logits(centerness_flatten, gt_ious)
            quality_loss = quality_loss * mask_positive_float / num_positive_fp32
        else:
        ...
        loss_all = {
            ...
            "loss_ctn": paddle.sum(quality_loss),
        }
