...
class LabelMatchEvalCallback(Callback):
    ...
    def eval_score_thr(self, results, percent):
        ...
        #     cls_thr[i]=cls_thr[i]*0.7+cls_thr_ig[i]*0.3
        # percent=0.4
        cls_thr=[0.80,0.63,0.66,0.74,0.87,0.90,0.90,0.69,0.57,0.57,0.90,0.94,0.64,0.52,0.52,0.85,0.82,0.84,0.73,0.75,0.90,0.84,0.89,0.92,0.53,0.72,0.46,0.60,0.66,0.88,0.50,0.52,0.72,0.68,0.62,0.69,0.74,0.71,0.81,0.63,0.52,0.63,0.48,0.47,0.47,0.67,0.49,0.50,0.63,0.52,0.58,0.50,0.51,0.87,0.75,0.64,0.59,0.69,0.60,0.77,0.65,0.90,0.81,0.87,0.75,0.56,0.64,0.57,0.79,0.73,0.44,0.64,0.72,0.42,0.81,0.65,0.44,0.75,0.14,0.47]
