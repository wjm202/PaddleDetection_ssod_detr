...
class Trainer(object):
    def __init__(self, cfg, mode='train'):
        ...
        if self.use_ema:
            ...
            if self.semi_supervised:
                logger.warning(
                    "Semi-Supervised Learning not work, please set 'use_meanteacher: True' in config."
                )
            ...
            for step_id, data in enumerate(self.loader):
                ...
                if self.use_amp:
                    ...
                    if isinstance(
                        ...
                        with model.no_sync():
                            # model forward
                            # data_sup_fake=np.load('fake_data.npy')
                            # data['image']=paddle.to_tensor(data_sup_fake)
        ...
        for epoch_id in range(self.start_epoch, self.cfg.epoch):
            ...
            for step_id, data_sup in enumerate(self.loader):
                ...
                if curr_iter > st_iter:
                    ...
                    # print(paddle.transpose(data_unsup_w["image"],[0, 2, 3, 1])[0][600][570])
