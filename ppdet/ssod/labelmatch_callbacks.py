...
class LabelMatchCallback(Callback):
    def __init__(self, trainer):
        ...
        boxes_per_image_gt, cls_ratio_gt = self.get_data_info(os.path.join(cfg.TrainDataset_sup.dataset_dir, cfg.TrainDataset_sup.anno_path))
...
class LabelMatchEvalCallback(Callback):
    ...
    def update_cls_thr(self):
        if self.broadcast_bn_buffer:
            self._broadcast_bn_buffer(self.model.teacher)
        ...
        percent = self.model.percent  # percent as positive
